	...
	initVis() {
		...
		vis.brush = d3.brushX()
			...
			.on("brush", function(event){
				...
				d3.select("#start-date").attr("value", dateFormatter(vis.currentBrushRegion[0]));
				d3.select("#end-date").attr("value", dateFormatter(vis.currentBrushRegion[1]));
			});
		...
		// 		vis.xOrig = vis.x;
		// 		vis.x = transform.rescaleX(vis.x);
